...
CONFIGURE_OPTIONS = '--with-php-config=/opt/php5/bin/php-config' '--enable-debug'
...
EXTENSION_DIR = /opt/php5/lib/php/extensions/debug-non-zts-20121212
PHP_EXECUTABLE = /opt/php5/bin/php
EXTRA_LDFLAGS =
EXTRA_LIBS =
INCLUDES = -I/opt/php5/include/php -I/opt/php5/include/php/main -I/opt/php5/include/php/TSRM -I/opt/php5/include/php/Zend -I/opt/php5/include/php/ext -I/opt/php5/include/php/ext/date/lib
LFLAGS =
LDFLAGS =
SHARED_LIBTOOL =
